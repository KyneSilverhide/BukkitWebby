...
Tooltip.prototype = {
	initialize : function(el, options) {
		...
		// 'content' option or 'title' attribute of the trigger element. If
		// 'content' is present, then 'title' attribute is ignored.
		// 'content' is an element or the id of an element from which the
		// innerHTML is taken as content of the tooltip
	...
	setOptions : function(options) {
		this.options = {
			...
			hideDuration : .25
		// Default disappear duration in sec
		};
	...
	appear : function() {
		...
		Element.extend(this.tooltip); // IE needs element to be manually
										// extended
		this.options.width = this.tooltip.getWidth() + 1; // Quick fix for
															// Firefox 3
		this.tooltip.style.width = this.options.width + 'px'; // IE7 needs
																// width to be
																// defined
